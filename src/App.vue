...
<script>
  ...
  export default {
    ...
    methods: {
      //region 无参请求示例
      async fetchTest() {
        await this.$request.call(this, apis.Test.joke, "joke", (data) => {
      ...
      async fetchTest2() {
        ...
        Object.assign(apis.Test.weather, obj); // 合并对象。将obj中的键值对浅拷贝weatherTest对象中
        await this.$request.call(this, apis.Test.weather, "weather"); // 获取数据后自动将数据绑定到weather上
